	...
	<div class="content-viewport">
		<div class="grid">
			...
			<div class="item-wrapper" style="padding: 5px;">
				<a href="#" class="btn btn-primary btn-xs float-right" style="margin: 5px 0;" onclick="getForm('<?= base_url('tambah-jadwal') ?>')" title="Tambah Data"><i class="mdi mdi-playlist-plus"></i>Tambah Data</a>
...
<script>
	var tblUrl = "<?= base_url('tbl-jadwal') ?>";
	...
	function submitData(ini, e){
        ...
        $.ajax({
            ...
            success:function(RESPONS){
				...
				// console.log(respons);
				if(respons[1]=="tambah"){
				    getForm("<?= base_url('tambah-jadwal') ?>");
			    }else{
			    	$(".modal").modal("hide");
			    }

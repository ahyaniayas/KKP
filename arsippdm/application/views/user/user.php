	...
	<div class="content-viewport">
		<div class="grid">
			...
			<div class="item-wrapper" style="padding: 5px;">
				<a href="#" class="btn btn-primary btn-xs float-right" style="margin: 5px 0;" onclick="getForm('<?= base_url('tambah-user') ?>')" title="Tambah Data"><i class="mdi mdi-playlist-plus"></i>Tambah Data</a>
